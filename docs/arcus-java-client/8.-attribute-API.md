...
Item attributes의 기본 설명은 [Arcus cache server의 item attributes 부분](/arcus-server/ARCUS-Server-Ascii-Protocol/1.11-(latest)/8.-Item-Attribute-Command)을 참고 하길 바란다.
